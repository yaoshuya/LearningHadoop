 ...
 * http://ita.ee.lbl.gov/html/contrib/NASA-HTTP.html. You can find a description
...
public class LogProcessor extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
	    ...
	    //System.out.println(job.getConfiguration().get("mapreduce.job.inputformat.class"));
				
	    /**** Delete the target path if exists ****/
	    Path outPath = new Path(outputPath); 
	    FileSystem dfs = FileSystem.get(outPath.toUri(), getConf()); 
